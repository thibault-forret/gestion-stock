...
@section('content')
    ...
    <div class="filter-form">
        <form action="{{ route('warehouse.invoice.filter.order') }}" method="get">
            <div class="search-element">
                <div>
                    <label for="store"><i class="fas fa-store"></i> Magasin :</label>
            ...
            <div class="invoices">
                ...
                @foreach ($invoices as $invoice)
                    ...
                    <div class="invoice">
                        ...
                        <div>
                            <a href="{{ route('warehouse.invoice.info.order', ['invoice_number' => $invoice->invoice_number]) }}"><i class="far fa-question-circle"></i> Informations</a>
                            <a target="_blank" href="{{ route('warehouse.order.invoice.show', ['invoice_number' => $invoice->invoice_number]) }}"><i class="far fa-eye"></i> Voir la facture</a>
                            <a target="_blank" href="{{ route('warehouse.order.invoice.download', ['invoice_number' => $invoice->invoice_number]) }}"><i class="fas fa-download"></i> Télécharger la facture</a>
                        </div>
                    </div>
                @endforeach
            </div>
